...
@Client.on_message(filters.private & filters.command("autorename") & filters.user(ADMIN_USER_ID))
...
@Client.on_message(filters.private & filters.command("setmedia") & filters.user(ADMIN_USER_ID))
