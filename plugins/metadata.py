...
@Client.on_message(filters.private & filters.command('metadata') & filters.user(ADMIN_USER_ID))
...
@Client.on_callback_query(filters.regex('.*?(custom_metadata|metadata).*?') & filters.user(ADMIN_USER_ID))
